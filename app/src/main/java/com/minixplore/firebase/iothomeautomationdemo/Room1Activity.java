...
public class Room1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference dataRef = firebaseDatabase.getReference("Room 1/Sensor Value");
        ...
        light_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (light_1.isChecked()){
                    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
                    DatabaseReference dataRef = firebaseDatabase.getReference("Room 1/Light 1");
                    dataRef.setValue("ON");
                }
                else {
                    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        ...
        light_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (light_2.isChecked()){
                    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
                    DatabaseReference dataRef = firebaseDatabase.getReference("Room 1/Light 2");
                    dataRef.setValue("ON");
                }
                else {
                    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
